...
//  COMMENT 
jQuery('#p1').bind('inview', function (event, visible) {
        if (visible == true) {
...
//  COMMENT 
jQuery('#p2').bind('inview', function (event, visible) {
        if (visible == true) {
            jQuery(this).addClass("animated fadeIn");
...
//  COMMENT 
jQuery('#box1').bind('inview', function (event, visible) {
        if (visible == true) {
...
//  COMMENT 
jQuery('#box2').bind('inview', function (event, visible) {
        if (visible == true) {
            jQuery(this).addClass("animated rollIn");
...
//  COMMENT 
jQuery('#box3').bind('inview', function (event, visible) {
        if (visible == true) {
            jQuery(this).addClass("animated rollIn");
...
//  COMMENT 
jQuery('#box4').bind('inview', function (event, visible) {
        if (visible == true) {
            jQuery(this).addClass("animated rollIn");
...
//  COMMENT 
jQuery('#arrow').bind('inview', function (event, visible) {
        if (visible == true) {
